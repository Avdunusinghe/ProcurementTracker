...
import 'package:procurement_mobile_app/src/common_widgets/detail_sub_card_view.dart';
import 'package:procurement_mobile_app/src/common_widgets/title_view.dart';
...
class CommonDashboard extends StatefulWidget {
  const CommonDashboard({Key? key, this.animationController}) : super(key: key);
