...
import 'package:procurement_mobile_app/main.dart';
            ...
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        color: ProcurementAppTheme.grey.withOpacity(0.2),
                                  ...
                                  Padding(
                                    ...
                                    child: CustomPaint(
                                      painter: CurvePainter(
                                          colors: [
                                            ProcurementAppTheme.nearlyDarkBlue,
                                            HexColor("#8A98E8"),
                                            HexColor("#8A98E8")
                                          ],
                                          angle: 140 +
                              ...
                              children: <Widget>[
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 16,
                                    letterSpacing: -0.2,
                                    color: ProcurementAppTheme.darkText,
                                  ),
                                ),
                                Padding(
